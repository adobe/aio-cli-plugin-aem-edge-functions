...
[Actions tab](https://github.com/adobe/aio-cli-plugin-aem-edge-functions/actions).

# Steps to do after the release

- Create a release note in https://github.com/adobe/aio-cli-plugin-aem-edge-functions/releases
